...
// Suggested By Apple to use Reachability for Network test
import Foundation
...
public class Reachability {
    ...
    required public init(reachabilityRef: SCNetworkReachability,
        ...
        self.reachabilitySerialQueue = DispatchQueue(label: "in.co.atul.reachability", qos: queueQoS, target: targetQueue)
